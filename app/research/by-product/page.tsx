...
export const metadata = {
  title: "Research by product · peopleanalyst",
  description:
...
export default function ResearchByProductIndex() {
        ...
        <section className="py-16 sm:py-24 grid grid-cols-1 lg:grid-cols-12 gap-x-8 gap-y-6">
          <div className="lg:col-span-8 space-y-6">
            ...
            <p className="text-base text-ink-body leading-relaxed max-w-[60ch]">
              This is the per-product axis. The default research index at{" "}
              <Link href="/research" className="text-accent hover:underline">
                /research
              </Link>{" "}
              organizes the same body of work by field-level arc — a more
              honest read of what cuts across products.
            </p>
          </div>
