...
export const PRODUCT_META: Record<ProductId, ProductMeta> = {
  ...
  "ai-human-interaction": {
    ...
    featuredEntrySlug: "loom-paper-01-public",
  },
};
...
export const MANIFEST: ManifestEntry[] = [
  ...
  },
  {
    product: "ai-human-interaction",
    category: "reports",
    slug: "loom-sub-paper-plan",
    title: "Loom Research Program — sub-paper plan (v1.0)",
    summary:
  ...
  },
  {
    ...
    slug: "engineering",
    title: "Engineering critique",
    summary: "Forthcoming — engineering reviewer's lens on the Loom Measurement Framework, the Adaptive Authorship Control Kernel (F-19), and the instrumentation discipline.",
    audienceTier: "engineering",
    status: "forthcoming",
  },
  {
    ...
    slug: "product",
    title: "Product implications",
    summary: "Forthcoming — what the program tells us to build next, in Loom and in adjacent authoring environments.",
    audienceTier: "product",
    status: "forthcoming",
  },
  {
  ...
  },
  {
    ...
    title: "Pipeline status",
    summary:
      "What's drafted (Paper 1 in two registers, the sub-paper plan, the field-mapping roadmap, 29 literature reviews, 6 syntheses) · what's queued (long-context-emergence review, OSF preregistrations, external-operator pilot) · what's gated on the Loom production system accumulating a useful run-in period of data.",
    status: "live",
  },
];
